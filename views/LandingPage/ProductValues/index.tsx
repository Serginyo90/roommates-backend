        ...
        <Grid container spacing={5}>
          <Grid item xs={12} md={4}>
            <div className={classes.item}>
              ...
              <Typography variant='h5'>
                Мы все такие разные, и найти с кем комофртно жить достаточно сложно.
          ...
          <Grid item xs={12} md={4}>
            <div className={classes.item}>
              ...
              <Typography variant='h5'>
                Если вы ни разу не снимали с кем-то жилье, то наш сервис это
                отличная шанс попробовать найти кого-то по интересам и увлечениям.
              </Typography>
            </div>
          </Grid>
        </Grid>
