...
export class InsertCountries1577273895634 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.manager.insert(Country, [
      ...
      { id: 182, name: 'Russia', iso3: 'RUS', iso2: 'RU', phoneCode: '+7', capital: 'Moscow', currency: 'RUB', isActive: true },
      ...
      { id: 230, name: 'Ukraine', iso3: 'UKR', iso2: 'UA', phoneCode: '+380', capital: 'Kiev', currency: 'UAH', isActive: true },
